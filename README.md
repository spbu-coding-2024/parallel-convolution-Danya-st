...
Pixel показывает самое слабое ускорение на всех размерах и при любом количестве потоков. При 8 потоках ускорение падает до 0.65–0.75× (то есть работает медленнее последовательной версии в некоторых случаях).
...
При увеличении числа потоков до 8 наблюдается снижение пропускной способности у всех стратегий.
